...
class MediaModel {
  ...
  // NOTE We use jfxsm.MediaPlayer as type parameter to ReadOnlyObjectWrapper so we can bind to MediaView.mediaPlayer
  // see proscalafx.ch08.VideoPlayer4.VideoView.initView
  private val _mediaPlayer = new ReadOnlyObjectWrapper[jfxsm.MediaPlayer](this, "mediaPlayer")
